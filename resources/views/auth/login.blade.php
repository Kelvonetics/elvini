        ...
        <div class="container-login100">
            ...
            <div class="wrap-login100" style="">
                ...
                @csrf
                    ...
                    <div class="form-group row pad-form">
                        <div class="col-xl-5 col-md-5 col-xs-12 pull-left pull-left" style="border-radius: 5px !important; text-decoration: none; margin-bottom: 10px">
                            <button class="login100-form-btn" type="submit" style="width: 100%"> Login </button>
                        </div>

                        <div class="col-xl-7 col-md-7 col-xs-12 pull-right" style="border-radius: 5px !important; text-decoration: none; width: 100%">
