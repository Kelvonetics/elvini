        ...
        <div class="modal-content">
          ...
          <div id="equity_div" style="display: none;">
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="equity_2" id="equity_2" required>
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="equity_3" id="equity_3" required>
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="equity_4" id="equity_4" required>
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="equity_5" id="equity_5" required>
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="equity_6" id="equity_6" required>
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="equity_7" id="equity_7" required>
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="equity_8" id="equity_8" required>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Year" name="year" id="year_mf" required>
                </div>
          </div>          
...
<script> //FUNCTIONS TO LOAD EDIT MODALS
    ...
    {   
        $('#edit_balamfield').load("{{url('admin')}}/modals/editBalaMarginalField?id="+id);
