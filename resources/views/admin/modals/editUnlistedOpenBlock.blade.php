<form id="opBlocForm" action="{{url('/admin/add_unlisted_open_block')}}" method="POST">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="" id="" class="btn btn-dark" onclick="return confirm('Are you sure you want to UPDATE Details?')"> <i class="fa fa-check"></i> Update Open Block </button>
          </div>
</form>
