...
class OpecPetroleumRepository
{
    ...
    function processPost()
    {
        ...
        switch (request()->type) {
            case 'savePetroleum':
//                return request()->all();
                return $this->saveData('\App\OpecPetroleum');
            default:
                return '';
...
//        return $petroleumData;
    ...
    function getMonthlyDataPetroleum($model)
    {
    ...
    function getPetroleumCalc()
    {

        $down_petroleum = $this->getMonthlyDataPetroleum('\App\down_refinery_production_volumes');
//        return $down_terminal_stream_prod;
        return $this->converToBopdStream($down_petroleum, 'quarter');
    }


    function getPetroleumImportCalc()
    {

        $down_petroleum_export = $this->getMonthlyDataPetroleum('\App\down_product_vol_import_permit');
//        return $down_terminal_stream_prod;
